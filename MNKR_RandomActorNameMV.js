...
The plugin parameters will be used as selection candidates.

Use this plugin by calling it from a plugin command.

MNKR_RandomActorNameMV actor ID list name

The control character \V[n] can be used in the command elements.

Example 1
MNKR_RandomActorNameMV 1 list1
Randomly select a name from list1 and rename actor ID1.

Example 2
MNKR_RandomActorNameMV \V[2] list2
Randomly select a name from list2 and rename the actor ID with the numeric
value in variable ID2.

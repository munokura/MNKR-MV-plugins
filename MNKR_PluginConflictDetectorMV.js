/**
 * --------------------------------------------------
 * MNKR_PluginConflictDetectorMV.js
 *   Ver.0.1.0
...
@author munokura
@url https://raw.githubusercontent.com/munokura/MNKR-MV-plugins/master/MNKR_PluginConflictDetectorMV.js
...
(() => {
    ...
    // パラメータ取得
    const config = {
        outputEnabled: PRMS['outputEnabled'] !== 'false',
        outputPath: String(PRMS['outputPath'] || 'data/'),
        outputTiming: String(PRMS['outputTiming'] || 'start'),
        showCompletionDialog: PRMS['showCompletionDialog'] !== 'false',
        dialogDisplayTime: Number(PRMS['dialogDisplayTime'] || 0),
    ...
    const CORE_CLASSES = [
        ...
        'Sprite_Base', 'Sprite_Button', 'Sprite_Character', 'Sprite_Battler',
        'Sprite_Actor', 'Sprite_Enemy', 'Sprite_Animation', 'Sprite_Damage',
        ...
        'Window_NameInput', 'Window_ChoiceList', 'Window_NumberInput', 'Window_EventItem',
    ...
    ConflictDetector.prototype.analyze = function () {
        ...
        const plugins = PluginManager._scripts || [];
